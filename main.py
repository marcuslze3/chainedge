...
class ChainEdgeAPI:
    ...
    def get_single_page(self, page):
        ...
        while True:
            response = requests.get('https://app.chainedge.io/alphastreamjson/', params=params, cookies=cookies, headers=headers)
        ...
        cols_to_remove_html = ['Address', 'sell_value', 'buy_token', 'buy_price', 'sell_token', 'sell_price']
